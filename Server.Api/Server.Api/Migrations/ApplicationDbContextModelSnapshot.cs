...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GovServices.Server.Entities.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GovServices.Server.Entities.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GovServices.Server.Entities.Department", b =>
                {
                    b.HasOne("GovServices.Server.Entities.Department", "ParentDepartment")
            ...
            modelBuilder.Entity("GovServices.Server.Entities.Service", b =>
                {
                    b.HasOne("GovServices.Server.Entities.Department", "ResponsibleDepartment")
                        .WithMany()
            ...
            modelBuilder.Entity("GovServices.Server.Entities.UserProfile", b =>
                {
                    ...
                    b.HasOne("GovServices.Server.Entities.Position", "Position")
                        .WithMany("UserProfiles")
                        .HasForeignKey("PositionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GovServices.Server.Entities.UserProfile", "Supervisor")
                    ...
                    b.HasOne("GovServices.Server.Entities.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("GovServices.Server.Entities.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
